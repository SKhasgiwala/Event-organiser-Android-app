...
public class MoneyActivity extends Activity implements OnClickListener {
	int pos;
	String[] web = { "T S Gandhi Seva Trust", "Gomukh Waterplus Society",
			"Unnati Mahila Sangh", "Humrahi", "Yuvghosh", "DeshPrem", "Prawah" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomList adapter = new CustomList(MoneyActivity.this, web, imageId);

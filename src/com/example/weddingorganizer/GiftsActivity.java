...
public class GiftsActivity extends Activity implements OnClickListener {
	int pos;
	String[] web = { "Prime Foundation", "Sara Foundation",
			"Amaltas Burhanpur", "Vimalganga Foundation", "Nict", "Sahodar",
			"Prawah" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomList adapter = new CustomList(GiftsActivity.this, web, imageId);
